...
public class ChoreServiceTest {
    ...
    @Test @DisplayName("#printChores > When the list is not empty > Print the descriptions")
    void printChoresWhenTheListIsNotEmptyPrintTheDescriptions(){
        ChoreService service = new ChoreService(); service.addChore("Chore 1",LocalDate.now().plusDays(3));
